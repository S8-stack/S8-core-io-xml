 ...
 *
 */
public abstract class OldObjectScope {
	

	protected String fieldNameInParent;
	
	protected OldObjectScope parent;
	
	public OldObjectScope(OldObjectScope parent, String fieldNameInParent) {
		super();
		this.parent = parent;
	...
	public abstract OldObjectScope createField(String tag) throws XML_ParsingException;
