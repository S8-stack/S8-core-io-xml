...
public class OldXML_Parser {
	...
	private Stack<OldElementParsing> stack;

	private OldRootParsedElement rootBuilder;

	public OldXML_Parser(XML_Context context, XML_StreamReader reader, boolean isVerbose) {
		super();
		this.isVerbose = isVerbose;
		this.reader = reader;
		rootBuilder = new OldRootParsedElement(context);
		stack = new Stack<>();
		state = readHeader;
	}
